...
public interface CalculatorVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link CalculatorParser#returnType}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitReturnType(CalculatorParser.ReturnTypeContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by the {@code negativeNumExprTag}
	 * labeled alternative in {@link CalculatorParser#expr}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitNegativeNumExprTag(CalculatorParser.NegativeNumExprTagContext ctx);
	/**
